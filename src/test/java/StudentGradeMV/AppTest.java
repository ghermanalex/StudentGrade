...
public class AppTest
{
    ...
    public void updateStudent() throws ValidatorException {
        ...
        assertEquals(932999,srv.find("1").getGrupa());
        ...
        assertEquals(9320,srv.find("1").getGrupa());
        assertEquals("ecom",srv.find("1").getEmail());
        ...
        assertEquals("sdfd!s",srv.find("1").getIndrumator());
    ...
    public void addAssignment() {
        ...
        TemaLab teme1 = new TemaLab(1,"dfgfdgfdg",12,12);
        TemaLab teme2 = new TemaLab(-1,"dfgfdgfdg",12,12);
        TemaLab teme3 = new TemaLab(13 ,"dfgfdgfdg",0,11);
        TemaLab teme4 = new TemaLab(14 ,"dfgfdgfdg",0,12);
        TemaLab teme5 = new TemaLab(18 ,"dfgfdgfdg",6,1);
        TemaLab teme6 = new TemaLab(20 ,"dfgfdgfdg",0,12);
